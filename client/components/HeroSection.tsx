...
export function HeroSection({ onScrollToSection }: HeroSectionProps) {
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-32 right-10 w-80 h-80 bg-gradient-to-tl from-accent/30 via-pink-600/20 to-transparent rounded-full blur-3xl animate-blob opacity-50"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="absolute top-1/2 left-0 w-72 h-72 bg-gradient-to-r from-blue-600/20 to-transparent rounded-full blur-3xl animate-blob opacity-40"
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8 w-full">
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="relative">
            <h1 className="text-7xl sm:text-8xl lg:text-9xl font-black leading-tight tracking-tighter">
              <span
                className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-gradient-shift"
              ...
              <br />
              <span
                className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 bg-clip-text text-transparent animate-gradient-shift"
        ...
        >
          <p className="text-xl sm:text-2xl lg:text-3xl text-gray-200 max-w-4xl mx-auto leading-relaxed font-light">
            ...
            <span className="font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              React, Node.js, and modern web tech
            </span>
          </p>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Full Stack Developer turning ideas into reality with clean code and
            stunning design
          </p>
        </div>
        ...
        >
          <button
            ...
            className="mx-auto block p-3 rounded-full border border-primary/30 hover:border-primary transition-all duration-300 hover:shadow-lg hover:shadow-primary/50 group"
          >
            <ChevronDown
              size={28}
      ...
      <div className="absolute top-20 right-5 opacity-10 text-8xl animate-float">
        💻
      </div>
      <div
        className="absolute bottom-32 left-5 opacity-10 text-8xl animate-float"
        style={{ animationDelay: "2s" }}
      >
        ⚡
      </div>
